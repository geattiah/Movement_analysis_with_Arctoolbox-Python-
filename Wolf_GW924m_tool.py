...
#Name and location of Minimum Bounding Geometry all
Minimum_Bounding_GW924m = arcpy.GetParameterAsText(7)

Minimum_Bounding_GW924m_untill_Jan = arcpy.GetParameterAsText(8)

Minimum_Bounding_GW924m_from_Feb = arcpy.GetParameterAsText(9)
...
#Minimum bounding geomatry
arcpy.MinimumBoundingGeometry_management(GW924m,Minimum_Bounding_GW924m, geometry_type="CONVEX_HULL", group_option="ALL", group_field="", mbg_fields_option="NO_MBG_FIELDS")


arcpy.MinimumBoundingGeometry_management(GW924m_untill_Jan,Minimum_Bounding_GW924m_untill_Jan, geometry_type="CONVEX_HULL", group_option="ALL", group_field="", mbg_fields_option="NO_MBG_FIELDS")


arcpy.MinimumBoundingGeometry_management(GW924m_from_Feb,Minimum_Bounding_GW924m_from_Feb, geometry_type="CONVEX_HULL", group_option="ALL", group_field="", mbg_fields_option="NO_MBG_FIELDS")
